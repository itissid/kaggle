...
plot.score.history = function(score.history) {
    ggplot(score.history %>% data.frame) +
...
It seems clear that 7/10 of the curves have a lower RMSE with learning rate = 0.01.
